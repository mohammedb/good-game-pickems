...
const steps: Array<{
...
}> = [
  {
    ...
    description:
      "Ready to make your predictions and climb the leaderboard? Let's show you around!",
    illustration: (
  ...
  },
  {
    ...
    description:
      'Browse upcoming matches and predict the winners. The more you get right, the higher you climb!',
    illustration: (
      <div className="flex justify-center">
        <motion.div
          animate={{
  ...
  },
  {
    ...
    description:
      'See how you stack up against other players. Can you reach the top spot?',
    illustration: (
      <div className="flex justify-center">
        <motion.div
          animate={{
  ...
  },
  {
    ...
    description:
      'View your stats, achievements, and prediction history in your profile.',
    illustration: (
      <div className="flex justify-center">
        <motion.div
          animate={{
  ...
  },
  {
    ...
    description:
      'Choose from different themes and color schemes to make the app your own.',
    illustration: (
      <div className="flex justify-center">
        <motion.div
          animate={{
  ...
  },
  {
    ...
    description:
      "Start making predictions and have fun! Don't forget to share your achievements with friends.",
    illustration: (
      <div className="flex justify-center">
        <motion.div
          animate={{
...
export function OnboardingTour() {
  const { currentStep, isOpen, setCurrentStep, completeOnboarding } =
    useOnboardingStore()
