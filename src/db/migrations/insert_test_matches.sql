...
-- This creates a mix of CS2, LoL, and Valorant matches with different statuses

-- First, delete existing test matches to avoid conflicts
DELETE FROM picks WHERE match_id IN (
...
DELETE FROM matches WHERE gg_ligaen_api_id IN (
  'test-cs2-1', 'test-cs2-2', 'test-cs2-3',
  'test-lol-1', 'test-lol-2',
...
-- Match 6: Finished Valorant match (Sentinels won)
(
  '66666666-6666-6666-6666-666666666666',
  'test-val-1',
  'sentinels-id',
  ...
  'Sentinels',
  '100 Thieves',
  'https://www.goodgameligaen.no/storage/images/teams/sentinels.png',
  'https://www.goodgameligaen.no/storage/images/teams/100thieves.png',
  NOW() - INTERVAL '3 hours',
  '13601',
  'test-2025',
  true,
...
-- Match 7: Upcoming Valorant match (in 1 hour)
(
  '77777777-7777-7777-7777-777777777777',
  'test-val-2',
  'cloud9-id',
  ...
  'Cloud9',
  'Evil Geniuses',
  'https://www.goodgameligaen.no/storage/images/teams/cloud9.png',
  'https://www.goodgameligaen.no/storage/images/teams/evilgeniuses.png',
  NOW() + INTERVAL '1 hour',
  '13601',
  'test-2025',
  false,
...
-- Correct prediction for Match 6
('YOUR-TEST-USER-ID-1', '66666666-6666-6666-6666-666666666666', 'sentinels-id', 10, true, NOW() - INTERVAL '4 hours');
*/

-- Update match points processing for finished matches
UPDATE matches 
SET points_processed = true 
WHERE id IN ('11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', '66666666-6666-6666-6666-666666666666');

-- Log message
DO $$
BEGIN
  RAISE NOTICE 'Successfully inserted 7 test matches:';
  ...
  RAISE NOTICE '- 1 Valorant finished match';
  RAISE NOTICE '- 1 Valorant upcoming match';
END $$;
